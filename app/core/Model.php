...
class Model
{
	...
	public function findFirst($params=[])
	{
		//dnd($params);
		// dnd($this->_table);
		//s$params = $this->_softDeleteParams($params);
		// dnd($params);
	...
	public function updateStudent($id ,$fields)
	{
		...
		//dnd($this->_table);
		if(empty($fields) || $id== "") return false;
		return $this->_db->updateStudent($this->_table, $id ,$fields);
	}

	public function updateConcellor($id ,$fields)
	{

		if(empty($fields) || $id== "") return false;
		return $this->_db->updateConcellor($this->_table, $id ,$fields);
	}
