...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      <li>Email Address:   ".$row["email"]."</br></ul>"
        ...
        ?>
        <button type="button" class="btn btn-primary"><a href="index3.php?CounselorID=<?php echo $CounselorID?>&StudentID=<?php echo $studentID?>">Choose the councellor</a></button>
